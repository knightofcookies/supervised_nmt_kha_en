...
def read_langs():
    ...
    with open("multi30k_train_en.txt", "r", encoding="utf-8") as f:
        en_lines = f.readlines()

    with open("multi30k_train_de.txt", "r", encoding="utf-8") as f:
        kha_lines = f.readlines()
